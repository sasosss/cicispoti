...
- `gameslop-1.2.0.zip` — packed extension (Chrome / Edge / Brave)
- `gameslop-1.2.0.xpi` — same package renamed for Firefox temporary install

## Install (Chrome / Edge / Brave)

### Option A — Unpacked (recommended for development)
1. Unzip `gameslop-1.2.0.zip` somewhere.
...
3. Drag `gameslop-1.2.0.zip` onto the page.
